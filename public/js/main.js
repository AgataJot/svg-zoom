  ...
  return {
    ...
    test: function test() {
      ...
      var tux = Snap.load('images/uk_union_flag.svg', function (loadedFragment2) {
        ...
        scaledClonedFlag.transform('s2.5');
...
},{"../components/question":176,"react/addons":3}],178:[function(require,module,exports){
// to depend on a bower installed component:
// define(['bower_components/componentName/file'])
...
},{"./components/app":175,"./components/reactedapp":177,"jQuery":2,"react/addons":3}]},{},[178])